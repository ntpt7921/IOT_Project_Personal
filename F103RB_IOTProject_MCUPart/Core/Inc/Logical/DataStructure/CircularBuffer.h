...
#ifndef INC_LOGICAL_DATASTRUCTURE_CIRCULARBUFFER_H_
#define INC_LOGICAL_DATASTRUCTURE_CIRCULARBUFFER_H_
 ...
 * and unoptimized. Operation takes various parameter:
...
#endif /* INC_LOGICAL_DATASTRUCTURE_CIRCULARBUFFER_H_ */
